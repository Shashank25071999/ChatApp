...
class _LoginAd extends State<LoginAd> {
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(onTap: (){
                          print(username);
                                              ...
                                              },child: Card(color: Colors.cyanAccent[200],clipBehavior: Clip.antiAlias,child: Container(width: MediaQuery.of(context).size.width/1.5,child: Padding(
                                                padding: const EdgeInsets.all(10.0),
                                                child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: <Widget>[
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text("Login",style: GoogleFonts.aBeeZee(color: Colors.black,fontWeight: FontWeight.bold),),
                                                    ),
                                                  ],
                                                ),
                                              ))),),
  ...
  final snackBar = SnackBar(content: Text(a,textAlign: TextAlign.center,style: GoogleFonts.aBeeZee(color:Colors.cyanAccent[200]),),backgroundColor: Colors.black,);
